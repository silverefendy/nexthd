...
def create_default_business_hours():
    """Buat Business Hours default jika belum ada. Senin-Jumat 08:00-17:00,
    Sabtu 08:00-15:00 (hari kerja), Minggu libur."""
    working_days = [
        ...
        {"day": "Sabtu", "start_time": "08:00:00", "end_time": "15:00:00", "is_working_day": 1},
...
def create_default_sla_policies():
    """Buat SLA Policy default untuk setiap level prioritas (sesuai SOP final 19 Agustus 2026)"""
    policies = [
        {"priority": "Kritis",  "response_time_minutes": 15,  "resolution_time_minutes": 60,    "is_24x7": 1},
        {"priority": "Tinggi",  "response_time_minutes": 30,  "resolution_time_minutes": 240,   "is_24x7": 0},
        {"priority": "Sedang",  "response_time_minutes": 60,  "resolution_time_minutes": 2880,  "is_24x7": 0},
        {"priority": "Rendah",  "response_time_minutes": 120, "resolution_time_minutes": 10080, "is_24x7": 0},
    ]
    ...
    for policy_data in policies:
        ...
        policy.is_24x7 = policy_data["is_24x7"]
