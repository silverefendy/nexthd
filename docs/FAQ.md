# NextHD — FAQ untuk Developer (Devin/Claude)
...
> (Workspace rusak pasca-migrate, Desktop Icon hilang, dst). Kalau kamu (Devin) sedang
> mengerjakan task yang menyentuh area ini, WAJIB baca dulu — jangan cuma andalkan
> deskripsi prompt task, karena prompt task sering tidak menyebutkan detail ini secara
> eksplisit.
>
> **Last updated:** 2026-08-22 17:00 WIB
...
2. `docs/POLA_KERJA_DAN_BUG.md §4` — riwayat bug lengkap, siapa tahu sudah pernah dibahas
3. Kalau task kamu berasal dari GitHub Issue/prompt Claude — ikuti scope yang tertulis di
...
Devin. Kalau kamu (Devin) baru saja menemukan masalah baru yang polanya mirip dengan salah
satu di atas tapi belum tercatat, laporkan di PR description supaya bisa ditambahkan ke
sini oleh Claude/Efendy di sesi berikutnya.*

*Update terakhir: 2026-08-22 17:00 WIB.*
