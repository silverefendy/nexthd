...
> ⚠️ **`docs/FAQ_DEVELOPER.md` WAJIB dibaca PALING PERTAMA**, sebelum menyentuh file apapun —
...
1. **`docs/FAQ_DEVELOPER.md`** ← **BACA DULU** — kurasi masalah berulang + hal yang tidak boleh diubah
...
> Pembagian kerja Claude/Devin/Efendy sudah dipindah ke `docs/FAQ_DEVELOPER.md` (Bagian A).
